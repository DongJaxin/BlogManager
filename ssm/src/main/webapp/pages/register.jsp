			...
			<div class="col-md-12 column">
				<div class="form-group">
					<div class="col-sm-10" style="margin:5px">
						<a>用户名</a><input id="username" name="username" class="form-control"
							type="text" placeholder="用户名"  />
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-10" style="margin:5px">
						<a>密码</a><input id="password" name="password" class="form-control"
							type="password" placeholder="密码"  />
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-10" style="margin:5px">
						<a>手机号</a><input id="phone" name="phone" class="form-control" type="text" placeholder="手机号"  />
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-10" style="margin:5px">
						<a>邮箱</a><input id="email" name="email" class="form-control" type="text" placeholder="邮箱"  />
					</div>
				</div>
				<div class="form-group">
